...
class XYZProcessor:
    def __init__(self, npArray):
        ...
        self.newModel = M(3)
        loaded_state_dict = torch.load('/Users/asiriindatissa/src/msc/ssl_ml_2023/work_dirs/model_lastJuly25th.pth')
    ...
    def process_xyz_array(self):
        if hasattr(self, 'xyz_array'):
            ...
            val_dataset = DataProcess( self.xyz_array,23, 80,training=True)
