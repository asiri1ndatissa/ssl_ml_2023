...
from torch.utils.data import DataLoader
from torch.utils.tensorboard import SummaryWriter
from confusionMatrix import createConfusionMatrix, classificationReport
...
train_dataset = D(load_train,num_classes,80, training=True)
val_dataset = D(load_val,num_classes,80, training=False)
